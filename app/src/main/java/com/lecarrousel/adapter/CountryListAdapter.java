...
public class CountryListAdapter extends BaseAdapter {
    ...
    private ArrayList<MasterDataModel.COUNTRIES> names;

    public CountryListAdapter(Context context, ArrayList<MasterDataModel.COUNTRIES> names) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        tv.setText(names.get(position).country_name);
